...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    // Teste se circle retorna undefined, caso o parâmetro passado não seja um número.  V
    // Teste se circle retorna um objeto.=====V
    // Teste se o objeto retornado possui 3 propriedades.=====V
    // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.====v
